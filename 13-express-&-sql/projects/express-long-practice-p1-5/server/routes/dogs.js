...
dogsRouter.get('/:dogId', validateDogId, (req, res) => {
  getDogById(req, res);
});

// adds a dog
dogsRouter.post('/', validateDogInfo, (req, res) => {
  createDog(req, res);
});

// updates a single dog
dogsRouter.put('/:dogId', validateDogId, validateDogInfo, (req, res) => {
  updateDog(req, res);
});

// deletes a single dog
dogsRouter.delete('/:dogId', validateDogId, (req, res) => {
  deleteDog(req, res);
});

dogsRouter.use('/:dogId', foodsRouter);
